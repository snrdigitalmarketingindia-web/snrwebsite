...
export const servicePages: ServicePage[] = [
  ...
  },
  {
    ...
    metaTitle: "Social Media Account Management — We Post to Your Facebook & Instagram | SNR Digital",
    metaDescription: "SNR Digital Marketing manages your Facebook Pages and Instagram Business accounts on your behalf. We create content, schedule posts, and publish with your permission — you stay in control.",
    hero: {
      badge: "Social Media Management",
      heading: "We Manage Your Facebook & Instagram — So You Don't Have To",
      subheading: "We create content and publish directly to your Facebook Business Page and Instagram Business account on your behalf. You authorise our access, review every post, and can revoke permissions at any time.",
      cta: "Start Managing My Accounts",
    },
    intro: "SNR Digital Marketing provides full social media account management for businesses across India. We access your Facebook Pages and Instagram Business accounts through Meta's official permission system — meaning you stay in complete control at all times. Our team handles content creation, scheduling, and publishing while you focus on running your business. Every post goes through an approval process before it goes live, and you receive a monthly report of everything published on your accounts.",
    benefits: [
      { icon: "📘", title: "Facebook Page Management", desc: "We publish posts, stories, and reels to your Facebook Business Page on your behalf, using access permissions you grant through Meta's official authorisation flow. You can revoke our access at any time." },
      { icon: "📸", title: "Instagram Business Account Management", desc: "We manage content for your Instagram Business account — feed posts, stories, and reels — published on your behalf with your explicit authorisation. We never access personal Instagram profiles." },
      { icon: "📅", title: "Shared Publishing Calendar", desc: "Every client receives access to a shared content calendar showing all planned posts before they are scheduled. Nothing goes live without your approval, and you can view the full history of published content at any time." },
      { icon: "✍️", title: "Content Creation", desc: "We create graphics, captions, and short video scripts tailored to your brand. Content is submitted for your review each month before it enters the publishing calendar." },
      { icon: "🔒", title: "Permission-Based, Secure Access", desc: "We connect to your accounts through Meta's official API. We access only the Facebook Pages and Instagram Business accounts you explicitly connect — never your personal profile, friends list, or any unrelated accounts." },
      { icon: "📊", title: "Monthly Performance Reports", desc: "At the end of each month we share a full report covering reach, engagement, follower growth, and enquiries generated — so you can see exactly what was published and how it performed." },
    ],
    process: [
      { step: 1, title: "Account Authorisation", desc: "You connect your Facebook Page and/or Instagram Business account through Meta's official permission flow. This gives us the specific access needed to publish on your behalf — no more, no less." },
      { step: 2, title: "Content Planning", desc: "We build a monthly content calendar covering themes, post types, and publishing times. The calendar is shared with you for review and approval before anything is scheduled." },
      { step: 3, title: "Content Creation", desc: "Our team creates graphics, captions, and short video scripts for each approved post, following your brand guidelines and the content plan you approved." },
      { step: 4, title: "Scheduling & Publishing", desc: "Once content is approved, we schedule posts using the agreed calendar and publish to your connected accounts at optimal times for your audience." },
      { step: 5, title: "Report & Review", desc: "At month end we share a full performance report — every post published, its reach and engagement, and recommendations for next month." },
    ],
    results: [
      { stat: "Your", label: "Accounts — you retain full ownership and control" },
      { stat: "Revoke", label: "Access removed instantly whenever you choose" },
      { stat: "30+", label: "Posts published per month per platform" },
      { stat: "Monthly", label: "Detailed reports of all activity on your accounts" },
    ],
    faqs: [
      { q: "How do you get access to my Facebook Page or Instagram account?", a: "You connect your accounts through Meta's official permission system — the same authorisation flow used by all Meta Business Partners. You grant us specific publishing permissions, and we can only access the accounts you explicitly connect." },
      { q: "Can I see what you're planning to post before it goes live?", a: "Yes — every client receives access to a shared content calendar. You review and approve all content before it is scheduled. Nothing is published without your sign-off." },
      { q: "What happens if I want to stop the service or remove your access?", a: "You can revoke our access at any time through your Facebook Page settings or Instagram account settings. We recommend letting us know first so we can pause the publishing calendar, but you are always in full control." },
      { q: "Do you access my personal Facebook profile?", a: "No. We only access the Facebook Pages and Instagram Business accounts you explicitly connect to our service. We have no access to your personal profile, your friends list, your personal messages, or any account you have not connected." },
      { q: "How do you handle the data from my accounts?", a: "We use account data solely to manage and publish content on your behalf. We do not sell, share, or transfer your data to any third party. Full details are in our Privacy Policy." },
      { q: "Which types of accounts can you manage?", a: "We manage Facebook Business Pages and Instagram Business or Creator accounts. We do not manage personal Facebook profiles or personal Instagram accounts." },
    ],
    schema: {
      "@context": "https://schema.org",
      "@type": "Service",
      ...
      "description": "SNR Digital Marketing manages Facebook Pages and Instagram Business accounts on behalf of clients, publishing content with explicit client authorisation through Meta's official permission system.",
    },
  },
  {
