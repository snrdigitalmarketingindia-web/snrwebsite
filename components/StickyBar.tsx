      ...
      <div className="max-w-6xl mx-auto px-4 py-2.5 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <a
            ...
            className="px-3 sm:px-5 py-1.5 rounded-lg text-xs sm:text-sm font-semibold inline-flex items-center gap-1.5 bg-[#25D366] text-white hover:bg-[#1da851] transition-colors"
          >
