    ...
    <section className="py-14 px-6 bg-[#111C35] border-y border-white/[0.06]">
      <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
          ...
          <a
            href="https://wa.me/919989437777?text=Hi%2C%20I%20want%20more%20customers%20for%20my%20business"
            target="_blank"
            rel="noopener noreferrer"
            className="px-6 py-3 rounded-xl font-semibold text-sm inline-flex items-center justify-center gap-2 border-2 border-green-500 text-green-400 hover:bg-green-500 hover:text-white transition-all duration-200 whitespace-nowrap"
          >
