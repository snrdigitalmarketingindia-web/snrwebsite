export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden glow-hero px-6 py-24">
      ...
      />
      {/* Blue glow orb */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] rounded-full bg-blue-600/12 blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <p className="text-2xl sm:text-3xl font-semibold text-white/90 mb-4">
          Get More Customers for Your Business Online
        </p>

        {/* Trust line */}
        <p className="text-base sm:text-lg text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
          Helping Businesses Across India Grow Through SEO, Ads &amp; Websites
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
          ...
          >
            ...
            Call Now &nbsp;+91 9989437777
          </a>
        </div>

        {/* Services strip */}
        <p className="text-slate-500 text-sm tracking-wide">
          SEO &nbsp;&bull;&nbsp; AI / GEO &nbsp;&bull;&nbsp; Google Ads &nbsp;&bull;&nbsp; Meta Ads &nbsp;&bull;&nbsp; Websites &nbsp;&bull;&nbsp; Mobile Apps
        </p>
      </div>
